...
set_property PACKAGE_PIN A20 [get_ports MISO]
set_property PACKAGE_PIN H16 [get_ports MOSI]
set_property PACKAGE_PIN B19 [get_ports SCK]
set_property PACKAGE_PIN B20 [get_ports {CS[0]}]
...
set_property PACKAGE_PIN C20 [get_ports {GPIO_0[0]}]
set_property PACKAGE_PIN H17 [get_ports {GPIO_0[1]}]
set_property PACKAGE_PIN D20 [get_ports {GPIO_0[2]}]
