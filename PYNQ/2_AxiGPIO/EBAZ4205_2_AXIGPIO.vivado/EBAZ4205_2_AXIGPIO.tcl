...
proc create_root_design { parentCell } {
  ...
  set DATA1_PORT [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 DATA1_PORT ]

  set DATA2_PORT [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 DATA2_PORT ]

  set DATA3 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 DATA3 ]

  set DATA3_PORT [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 DATA3_PORT ]

  set DDR [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ddrx_rtl:1.0 DDR ]

  set FIXED_IO [ create_bd_intf_port -mode Master -vlnv xilinx.com:display_processing_system7:fixedio_rtl:1.0 FIXED_IO ]

  set LEDS_PORT [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 LEDS_PORT ]
  ...
  # Create instance: gpio_data1, and set properties
  set gpio_data1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 gpio_data1 ]
  ...
  # Create instance: gpio_data2, and set properties
  set gpio_data2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 gpio_data2 ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {0} \
   CONFIG.C_DOUT_DEFAULT {0x00000000} \
   CONFIG.C_GPIO_WIDTH {14} \
  ...
  # Create instance: gpio_data3, and set properties
  set gpio_data3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 gpio_data3 ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {0} \
   CONFIG.C_DOUT_DEFAULT {0x00000000} \
   CONFIG.C_GPIO_WIDTH {14} \
  ...
  set_property -dict [ list \
   CONFIG.GPIO_BOARD_INTERFACE {leds_2bits} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $gpio_leds
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports LEDS_PORT] [get_bd_intf_pins gpio_leds/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO1 [get_bd_intf_ports DATA1_PORT] [get_bd_intf_pins gpio_data1/GPIO]
  connect_bd_intf_net -intf_net data2_GPIO [get_bd_intf_ports DATA2_PORT] [get_bd_intf_pins gpio_data2/GPIO]
  connect_bd_intf_net -intf_net gpio_data3_GPIO [get_bd_intf_ports DATA3_PORT] [get_bd_intf_pins gpio_data3/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins gpio_leds/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins gpio_data1/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins gpio_data2/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins gpio_data3/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins gpio_data1/s_axi_aclk] [get_bd_pins gpio_data2/s_axi_aclk] [get_bd_pins gpio_data3/s_axi_aclk] [get_bd_pins gpio_leds/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins gpio_data1/s_axi_aresetn] [get_bd_pins gpio_data2/s_axi_aresetn] [get_bd_pins gpio_data3/s_axi_aresetn] [get_bd_pins gpio_leds/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs gpio_leds/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs gpio_data1/S_AXI/Reg] SEG_axi_gpio_0_Reg1
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs gpio_data2/S_AXI/Reg] SEG_data2_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41230000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs gpio_data3/S_AXI/Reg] SEG_data3_Reg
