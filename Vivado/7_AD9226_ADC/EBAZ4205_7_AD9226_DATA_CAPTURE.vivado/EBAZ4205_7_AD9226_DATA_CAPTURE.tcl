...
proc create_root_design { parentCell } {
  ...
  set ADC_OTR [ create_bd_port -dir I -type data ADC_OTR ]
  ...
  # Create instance: axis_capture_0, and set properties
  set axis_capture_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axis_capture:1.0 axis_capture_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins axis_capture_0/ctrl_s_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net ADC_IN_1 [get_bd_ports ADC_IN] [get_bd_pins xlconcat_2/In2]
  connect_bd_net -net ADC_OTR_1 [get_bd_ports ADC_OTR] [get_bd_pins xlconcat_2/In0]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axis_capture_0/ctrl_s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports ADC_CLK_64M] [get_bd_pins axis_capture_0/capture_clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axis_capture_0/ctrl_s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  connect_bd_net -net xlconcat_3_dout [get_bd_pins axis_capture_0/capture_data] [get_bd_pins xlconcat_3/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axis_capture_0/capture_valid] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconcat_3/In0] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins xlconcat_2/In1] [get_bd_pins xlconstant_2/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axis_capture_0/ctrl_s_axi/reg0] SEG_axis_capture_0_reg0
