...
proc create_root_design { parentCell } {
  ...
  set HPD_IN [ create_bd_port -dir O -from 0 -to 0 HPD_IN ]
  set HPD_OUT [ create_bd_port -dir O -from 0 -to 0 HPD_OUT ]
  ...
  connect_bd_net -net clk_wiz_0_clk_200MHz [get_bd_pins clk_wiz_0/clk_200MHz] [get_bd_pins dvi2rgb_0/RefClk]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_ports HPD_IN] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_ports HPD_OUT] [get_bd_pins xlconstant_1/dout]
